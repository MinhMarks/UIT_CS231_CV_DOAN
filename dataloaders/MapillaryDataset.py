...
DATA_INDEX_ROOT = '/kaggle/input/salad/pytorch/petlsalad/1/datasets/msls_val/'
...
class MSLS(Dataset):
    def __init__(self, input_transform = None):
        ...
        # hard coded reference image names, this avoids the hassle of listing them at each epoch.
        self.dbImages = np.load('/kaggle/input/salad/pytorch/petlsalad/1/datasets/msls_val/msls_val_dbImages.npy')
        
        # hard coded query image names.
        self.qImages = np.load('/kaggle/input/salad/pytorch/petlsalad/1/datasets/msls_val/msls_val_qImages.npy')
        
        # hard coded index of query images
        self.qIdx = np.load('/kaggle/input/salad/pytorch/petlsalad/1/datasets/msls_val/msls_val_qIdx.npy')
        
        # hard coded groundtruth (correspondence between each query and its matches)
        self.pIdx = np.load('/kaggle/input/salad/pytorch/petlsalad/1/datasets/msls_val/msls_val_pIdx.npy', allow_pickle=True)
